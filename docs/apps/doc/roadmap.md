...
| M4 | Views on the page: build a layout from keys, see the preview tree; missing-key default, clean segments, numbered duplicates | not started |
| M4a | `dgs doc verify` | not started |
