...
| `geo.gpx.tiles` | Base maps the page offers after the built-in ones (OpenStreetMap, Gaode, Gaode Satellite, Esri World Imagery), in this order. | empty — the built-in maps only |
