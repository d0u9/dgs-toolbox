...
var catalogue = []Type{
	...
	{Name: "memorabilia", Label: "Memorabilia", Covers: "Personal keepsakes: yearbooks, commemorative books, invitations and cards kept for their memories", Nature: Keepsake, Key: 'b'},
